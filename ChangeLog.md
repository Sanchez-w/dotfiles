...
- 使用了[marksman](https://github.com/artempyanykh/marksman)实现笔记的双向链接，用mason.nvim安装，好像确实开箱即用
- 使用[cbfmt](https://github.com/lukas-reineke/cbfmt)配合[conform.nvim](https://www.github.com/stevearc/conform.nvim)插件实现MD文件中不同代码块的格式化
